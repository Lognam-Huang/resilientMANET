...
# print(get_gu_to_uav_connections(ground_users, UAV_nodes, UAVInfo, blocks))
...
for cur_time_frame in range(sim_time):  
    ...
    scene_visualization(ground_users=ground_users, UAV_nodes=UAV_nodes, air_base_station=BS_nodes, blocks=blocks, scene_info=scene, current_state = best_state, line_alpha=0.5, show_axes_labels=False)
