...
from node_functions import add_or_remove_gu, set_baseline_backhaul
...
# print_node(baseline_UAV_nodes)
from visualization_functions import visualize_simulation, visualize_simulation_with_baseline
# visualize_simulation(baseline_uav_connections_TD, baseline_gu_capacity_TD, num_UAV)
# visualize_simulation_with_baseline(baseline_uav_connections_TD, baseline_gu_capacity_TD, baseline_uav_connections_TD, baseline_gu_capacity_TD, num_UAV)
